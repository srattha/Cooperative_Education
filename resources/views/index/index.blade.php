...
<div class="container-fluid" style="margin-top: -85px;">
   <div class="sidebar">
      <!-- menu nav-->
      <nav>
         <ul class="mcd-menu" style="background-color: #F1F1F1;">
            <li>
               <a href="">
   ...
   <div class="content">
      ...
      <div class="content-inner" style="margin-left: 300px; margin-top: 50px;">
         ...
         <div class="text-inner">
            <h4 style="font-weight: bold">สหกิจศึกษาและการฝึกานทางวิศวกรรมคืออะไร</h4>
            ...
            <h4 style="font-weight: bold">หลักการและเตุผล</h4>
            ...
            <h4 style="font-weight: bold">วัตถุประสงค์</h4>
